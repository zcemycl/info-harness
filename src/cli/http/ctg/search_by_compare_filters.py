"""Thin CLI for CTG compare-filter search."""
...
from hc_http.ctg.search_by_compare_filters import DEFAULT_CACHE_KEY
...
from tools.ctg.search_ctg_by_compare_filters import search_ctg_by_compare_filters
...
def search_by_compare_filters(
    ...
    """Search CTG studies by compare filters (HC API)."""
    try:
        results = search_ctg_by_compare_filters(
