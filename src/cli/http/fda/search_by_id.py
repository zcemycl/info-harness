"""Thin CLI wrapper for FDA label search by setid."""
...
from tools.fda.search_fdalabel_by_id import search_fdalabel_by_id
...
def search_by_id(
    ...
    """Search FDA labels by setid (HC API)."""
    try:
        results = search_fdalabel_by_id(
            setid,
