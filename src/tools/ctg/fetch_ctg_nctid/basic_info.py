"""Fetch live CT.gov by NCT id; return basic_info section only."""
...
def fetch_ctg_nctid_basic_info(
    nctid: str,
    *,
    offset: int = 0,
    limit: int = 5,
) -> CtgAttrPage[CtgAttrHit]:
    """Fetch by NCT id; return basic_info page."""
    return fetch_ctg_nctid_attr(
        CtgAttrName.BASIC_INFO, nctid, offset=offset, limit=limit
    )
