"""Fetch live CT.gov by NCT id; return demographics section only."""
...
def fetch_ctg_nctid_demographics(
    nctid: str,
    *,
    offset: int = 0,
    limit: int = 5,
) -> CtgAttrPage[CtgAttrHit]:
    """Fetch by NCT id; return demographics page."""
    return fetch_ctg_nctid_attr(
        CtgAttrName.DEMOGRAPHICS, nctid, offset=offset, limit=limit
    )
