"""Fetch live CT.gov by NCT id; return locations section only."""
...
def fetch_ctg_nctid_locations(
    nctid: str,
    *,
    offset: int = 0,
    limit: int = 5,
) -> CtgAttrPage[CtgAttrHit]:
    """Fetch by NCT id; return locations page."""
    return fetch_ctg_nctid_attr(
        CtgAttrName.LOCATIONS, nctid, offset=offset, limit=limit
    )
