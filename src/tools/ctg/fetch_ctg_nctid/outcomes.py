"""Fetch live CT.gov by NCT id; return outcomes section only."""
...
def fetch_ctg_nctid_outcomes(
    nctid: str,
    *,
    offset: int = 0,
    limit: int = 5,
) -> CtgAttrPage[CtgAttrHit]:
    """Fetch by NCT id; return outcomes page."""
    return fetch_ctg_nctid_attr(CtgAttrName.OUTCOMES, nctid, offset=offset, limit=limit)
