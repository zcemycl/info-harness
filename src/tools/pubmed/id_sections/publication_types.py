"""Fetch PubMed by PMID; return publication_types section only."""
...
def pubmed_id_publication_types(
    pmid: str,
    *,
    offset: int = 0,
    limit: int = 20,
) -> PubmedAttrPage[PubmedAttrHit]:
    """Fetch by PMID; return publication_types page."""
    return pubmed_id_attr(
        PubmedAttrName.PUBLICATION_TYPES, pmid, offset=offset, limit=limit
    )
