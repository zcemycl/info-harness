"""Search FDA labels by indication; return clinical_trials hits only."""
...
def search_fdalabel_indication_clinical_trials(
    indication: str,
    *,
    ...
    """Search by indication; return id/setid/tradename/clinical_trials page."""
