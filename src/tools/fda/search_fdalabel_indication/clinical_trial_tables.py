"""Search FDA labels by indication; return clinical_trial_tables hits only."""
...
def search_fdalabel_indication_clinical_trial_tables(
    indication: str,
    *,
    ...
    """Search by indication; return id/setid/tradename/clinical_trial_tables page."""
