"""Search FDA labels by indication; return companies hits only."""
...
def search_fdalabel_indication_companies(
    indication: str,
    *,
    ...
    """Search by indication; return id/setid/tradename/companies page."""
    return search_fdalabel_indication_attr(
        FdaAttrName.COMPANIES,
        indication,
        versions=versions,
        maxn=maxn,
        offset=offset,
