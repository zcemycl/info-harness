"""Search FDA labels by indication; return dosage_forms hits only."""
...
def search_fdalabel_indication_dosage_forms(
    indication: str,
    *,
    ...
    """Search by indication; return id/setid/tradename/dosage_forms page."""
