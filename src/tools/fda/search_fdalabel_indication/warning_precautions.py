"""Search FDA labels by indication; return warning_precautions hits only."""
...
def search_fdalabel_indication_warning_precautions(
    indication: str,
    *,
    ...
    """Search by indication; return id/setid/tradename/warning_precautions page."""
