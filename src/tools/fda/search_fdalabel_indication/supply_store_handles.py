"""Search FDA labels by indication; return supply_store_handles hits only."""
...
def search_fdalabel_indication_supply_store_handles(
    indication: str,
    *,
    ...
    """Search by indication; return id/setid/tradename/supply_store_handles page."""
