"""Search FDA labels by indication; return drug_interactions hits only."""
...
def search_fdalabel_indication_drug_interactions(
    indication: str,
    *,
    ...
    """Search by indication; return id/setid/tradename/drug_interactions page."""
