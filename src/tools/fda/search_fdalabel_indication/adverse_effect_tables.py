"""Search FDA labels by indication; return adverse_effect_tables hits only."""
...
def search_fdalabel_indication_adverse_effect_tables(
    indication: str,
    *,
    ...
    """Search by indication; return id/setid/tradename/adverse_effect_tables page."""
