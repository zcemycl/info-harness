"""Search FDA labels by indication; return dosage_administrations hits only."""
...
def search_fdalabel_indication_dosage_administrations(
    indication: str,
    *,
    ...
    """Search by indication; return id/setid/tradename/dosage_administrations page."""
