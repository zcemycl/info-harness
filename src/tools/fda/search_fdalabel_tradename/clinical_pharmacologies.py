"""Search FDA labels by tradename; return clinical_pharmacologies hits only."""
...
def search_fdalabel_tradename_clinical_pharmacologies(
    tradename: str,
    *,
    ...
    """Search by tradename; return id/setid/tradename/clinical_pharmacologies page."""
