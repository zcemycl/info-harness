"""Search FDA labels by tradename; return adverse_effect_tables hits only."""
...
def search_fdalabel_tradename_adverse_effect_tables(
    tradename: str,
    *,
    ...
    """Search by tradename; return id/setid/tradename/adverse_effect_tables page."""
