"""Search FDA labels by tradename; return drug_interactions hits only."""
...
def search_fdalabel_tradename_drug_interactions(
    tradename: str,
    *,
    ...
    """Search by tradename; return id/setid/tradename/drug_interactions page."""
