"""Search FDA labels by tradename; return warning_precautions hits only."""
...
def search_fdalabel_tradename_warning_precautions(
    tradename: str,
    *,
    ...
    """Search by tradename; return id/setid/tradename/warning_precautions page."""
