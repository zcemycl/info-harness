"""Search FDA labels by tradename; return contraindications hits only."""
...
def search_fdalabel_tradename_contraindications(
    tradename: str,
    *,
    ...
    """Search by tradename; return id/setid/tradename/contraindications page."""
