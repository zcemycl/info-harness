"""Search FDA labels by tradename; return therapeutic_areas hits only."""
...
def search_fdalabel_tradename_therapeutic_areas(
    tradename: str,
    *,
    ...
    """Search by tradename; return id/setid/tradename/therapeutic_areas page."""
