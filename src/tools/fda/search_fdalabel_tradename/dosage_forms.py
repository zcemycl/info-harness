"""Search FDA labels by tradename; return dosage_forms hits only."""
...
def search_fdalabel_tradename_dosage_forms(
    tradename: str,
    *,
    ...
    """Search by tradename; return id/setid/tradename/dosage_forms page."""
