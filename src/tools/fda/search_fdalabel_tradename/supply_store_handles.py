"""Search FDA labels by tradename; return supply_store_handles hits only."""
...
def search_fdalabel_tradename_supply_store_handles(
    tradename: str,
    *,
    ...
    """Search by tradename; return id/setid/tradename/supply_store_handles page."""
