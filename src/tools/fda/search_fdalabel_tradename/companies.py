"""Search FDA labels by tradename; return companies hits only."""
...
def search_fdalabel_tradename_companies(
    tradename: str,
    *,
    ...
    """Search by tradename; return id/setid/tradename/companies page."""
