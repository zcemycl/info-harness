"""Search FDA labels by tradename; return dosage_administrations hits only."""
...
def search_fdalabel_tradename_dosage_administrations(
    tradename: str,
    *,
    ...
    """Search by tradename; return id/setid/tradename/dosage_administrations page."""
