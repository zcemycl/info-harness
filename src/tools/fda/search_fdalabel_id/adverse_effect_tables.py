"""Search FDA labels by setid; return adverse_effect_tables hits only."""
...
def search_fdalabel_id_adverse_effect_tables(
    setid: str,
    *,
    ...
    """Search by setid; return id/setid/tradename/adverse_effect_tables page."""
