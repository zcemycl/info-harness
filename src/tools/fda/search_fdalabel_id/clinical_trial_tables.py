"""Search FDA labels by setid; return clinical_trial_tables hits only."""
...
def search_fdalabel_id_clinical_trial_tables(
    setid: str,
    *,
    ...
    """Search by setid; return id/setid/tradename/clinical_trial_tables page."""
