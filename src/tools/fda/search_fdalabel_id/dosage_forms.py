"""Search FDA labels by setid; return dosage_forms hits only."""
...
def search_fdalabel_id_dosage_forms(
    setid: str,
    *,
    ...
    """Search by setid; return id/setid/tradename/dosage_forms page."""
