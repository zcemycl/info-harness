"""Search FDA labels by setid; return dosage_administrations hits only."""
...
def search_fdalabel_id_dosage_administrations(
    setid: str,
    *,
    ...
    """Search by setid; return id/setid/tradename/dosage_administrations page."""
