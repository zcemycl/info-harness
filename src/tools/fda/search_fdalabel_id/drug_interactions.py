"""Search FDA labels by setid; return drug_interactions hits only."""
...
def search_fdalabel_id_drug_interactions(
    setid: str,
    *,
    ...
    """Search by setid; return id/setid/tradename/drug_interactions page."""
