"""Search FDA labels by setid; return contraindications hits only."""
...
def search_fdalabel_id_contraindications(
    setid: str,
    *,
    ...
    """Search by setid; return id/setid/tradename/contraindications page."""
