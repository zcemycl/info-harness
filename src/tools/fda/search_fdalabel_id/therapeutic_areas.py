"""Search FDA labels by setid; return therapeutic_areas hits only."""
...
def search_fdalabel_id_therapeutic_areas(
    setid: str,
    *,
    ...
    """Search by setid; return id/setid/tradename/therapeutic_areas page."""
