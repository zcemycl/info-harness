"""Search FDA labels by setid; return clinical_pharmacologies hits only."""
...
def search_fdalabel_id_clinical_pharmacologies(
    setid: str,
    *,
    ...
    """Search by setid; return id/setid/tradename/clinical_pharmacologies page."""
