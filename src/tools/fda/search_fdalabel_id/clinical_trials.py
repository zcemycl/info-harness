"""Search FDA labels by setid; return clinical_trials hits only."""
...
def search_fdalabel_id_clinical_trials(
    setid: str,
    *,
    ...
    """Search by setid; return id/setid/tradename/clinical_trials page."""
