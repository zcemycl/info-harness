"""Search FDA labels by setid; return supply_store_handles hits only."""
...
def search_fdalabel_id_supply_store_handles(
    setid: str,
    *,
    ...
    """Search by setid; return id/setid/tradename/supply_store_handles page."""
