"""Search FDA labels by setid; return warning_precautions hits only."""
...
def search_fdalabel_id_warning_precautions(
    setid: str,
    *,
    ...
    """Search by setid; return id/setid/tradename/warning_precautions page."""
