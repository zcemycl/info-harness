"""Search FDA labels by therapeutic area; return clinical_trial_tables hits only."""
...
def search_fdalabel_therapeutic_area_clinical_trial_tables(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return clinical_trial_tables page."""
