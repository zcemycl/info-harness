"""Search FDA labels by therapeutic area; return indication hits only."""
...
def search_fdalabel_therapeutic_area_indication(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return indication page."""
