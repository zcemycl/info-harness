"""Search FDA labels by therapeutic area; return companies hits only."""
...
def search_fdalabel_therapeutic_area_companies(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return companies page."""
