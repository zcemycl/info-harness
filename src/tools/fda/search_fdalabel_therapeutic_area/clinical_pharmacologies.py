"""Search FDA labels by therapeutic area; return clinical_pharmacologies hits only."""
...
def search_fdalabel_therapeutic_area_clinical_pharmacologies(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return clinical_pharmacologies page."""
