"""Search FDA labels by therapeutic area; return contraindications hits only."""
...
def search_fdalabel_therapeutic_area_contraindications(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return contraindications page."""
