"""Search FDA labels by therapeutic area; return dosage_administrations hits only."""
...
def search_fdalabel_therapeutic_area_dosage_administrations(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return dosage_administrations page."""
