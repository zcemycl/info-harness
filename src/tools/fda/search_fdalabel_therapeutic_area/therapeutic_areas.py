"""Search FDA labels by therapeutic area; return therapeutic_areas hits only."""
...
def search_fdalabel_therapeutic_area_therapeutic_areas(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return therapeutic_areas page."""
