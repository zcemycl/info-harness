"""Search FDA labels by therapeutic area; return clinical_trials hits only."""
...
def search_fdalabel_therapeutic_area_clinical_trials(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return clinical_trials page."""
