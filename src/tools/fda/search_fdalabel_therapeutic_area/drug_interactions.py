"""Search FDA labels by therapeutic area; return drug_interactions hits only."""
...
def search_fdalabel_therapeutic_area_drug_interactions(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return drug_interactions page."""
