"""Search FDA labels by therapeutic area; return adverse_effect_tables hits only."""
...
def search_fdalabel_therapeutic_area_adverse_effect_tables(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return adverse_effect_tables page."""
