"""Search FDA labels by therapeutic area; return indication_usages hits only."""
...
def search_fdalabel_therapeutic_area_indication_usages(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return indication_usages page."""
