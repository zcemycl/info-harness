"""Search FDA labels by therapeutic area; return warning_precautions hits only."""
...
def search_fdalabel_therapeutic_area_warning_precautions(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return warning_precautions page."""
