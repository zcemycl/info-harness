"""Search FDA labels by therapeutic area; return dosage_forms hits only."""
...
def search_fdalabel_therapeutic_area_dosage_forms(
    ta_description: str,
    *,
    ...
    """Search by therapeutic area; return dosage_forms page."""
